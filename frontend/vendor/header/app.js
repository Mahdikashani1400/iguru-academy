...
<nav
  class="navbar navbar-expand-xl navbar__header__menu bg-body-tertiary border-bottom border-secondary bg-transparent"
>
...
<script src="vendor/Bootstrap/bootstrap.bundle.min.js" type="module"></script>

<script src="vendor/FontAwesome5/all.min.js" type="module"></script>
`;
...
class Header extends HTMLElement {
  ...
  connectedCallback() {
    ...
    let headerSection = $.querySelector(".header");
    ...
    // linkElem.setAttribute("src", "vendor/Bootstrap/bootstrap.bundle.min.js");
    // linkElem.setAttribute("type", "module");

    // // Attach the created element to the shadow DOM
    // document.querySelector(".header").appendChild(linkElem);
  }
