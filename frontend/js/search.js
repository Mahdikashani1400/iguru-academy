...
`;
  if (!searchValueInfos.allResultCourses.length && !searchValueInfos.allResultArticles.length) {
    coursesContainer.innerHTML = `<div class="empty__comments d-flex p justify-content-center align-items-center py-4 py-sm-5 w-100 mx-auto text-white rounded-3 fs-5 mt-3" >جستجوی شما نتیجه ای در بر نداشت ...</div>`
